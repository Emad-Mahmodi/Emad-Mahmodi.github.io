...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "This is Emad mahmodi public project",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "A reproducible empirical study of GPU acceleration strategies (BFS, PageRank, WCC, Louvain) on skewed, power-law graphs — from a sequential C++ baseline through OpenMP to CUDA.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%65%6D%61%64.%6D%61%68%6D%6F%64%69.%65%6E%67@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/emad-mahmodi", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Emad-Mahmodi", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=ZrJX2noAAAAJ", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
